...
<html lang="en">
  <head>
   <title>Classic Beauty Treatments at Beauty With Christina</title>
    <meta charset="utf-8">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "name": "Classic Beauty Treatments at Beauty With Christina",
      "provider": {
        "@type": "LocalBusiness",
...
<!-- Body Aesthetic Courses Section -->
        ...
        <div class="container-fluid px-md-5">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-12 heading-section ftco-animate text-center">
                    <h3 class="subheading">Spoil Yourself</h3>
                    <h2 class="mb-1">Classic Beauty Treatments</h2>
              </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="treatment">
            <h2 class="display-6 mb-4">Nail Care</h2>
            <!-- Manicure -->
        ...
        <div class="treatment mt-5">
            <h2 class="display-6 mb-4">Hair Removal</h2>

            <!-- Body Waxing -->
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8 col-12 order-md-first">
                    <h3 class="fw-bold">Body Waxing</h3>
        ...
        <div class="treatment mt-5">
            <h2 class="display-6 mb-4">Brow &amp; Lash Enhancements</h2>

            <!-- Eyebrow Waxing -->
            <div class="row align-items-center mb-4">
                <div class="col-lg-8 col-md-8 col-12 order-md-first">
                    <h3 class="fw-bold">Eyebrow Waxing</h3>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8 col-12 order-md-first">
                    <h3 class="fw-bold">Lash &amp; Brow Tinting</h3>
        ...
        <div class="treatment mt-5">
            <h2 class="display-6 mb-4">Classic Beauty Massage</h2>

            <!-- Swedish Massage -->
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-8 col-12 order-md-first">
                    <h3 class="fw-bold">Swedish Massage</h3>
