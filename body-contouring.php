...
<html lang="en">
<head>
    <title>Body Contouring at Beauty With Christina</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Transform your body with professional body contouring services at Beauty With Christina in Eastbourne. Achieve your ideal shape with our advanced treatments.">
    <meta name="keywords" content="Body Contouring, weight loss, fat reduction, Beauty With Christina, Eastbourne">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "name": "Body Contouring at Beauty With Christina",
      "provider": {
        "@type": "LocalBusiness",
...
<body>
  ...
  <section class="ftco-section">
		...
		<div class="row justify-content-center mb-5 pb-3">
        	...
        	<h3 class="subheading">Sculpt &amp; Define Your Body</h3>
<h2 class="mb-1">Body Contouring Treatments</h2>
    	</div>
	</div>	
