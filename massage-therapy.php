...
<html lang="en">
<head>
    <title>Massage Treatments - Beauty With Christina Eastbourne</title>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta name="description" content="Explore luxurious massage treatments at Beauty With Christina in Eastbourne. Relax, rejuvenate, and unwind with expert care."/>
    <meta name="keywords" content="Massage treatments, Swedish massage, relaxation, rejuvenation, Beauty With Christina, Eastbourne"/>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "name": "Massage Treatments at Beauty With Christina",
      "provider": {
        "@type": "LocalBusiness",
...
<?php include 'menu.php'; ?>
    ...
    <!-- Hero Section -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/massage-treatments-banner.jpeg');" data-stellar-background-ratio="0.5">
        <div class="overlay">&nbsp;</div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <div class="title-wrapper">
                        <h1 class="mb-3 bread">Massage Treatments</h1>
                        <p class="breadcrumbs">
        ...
        <div class="container-fluid px-md-5">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-12 heading-section ftco-animate text-center">
                    <h3 class="subheading">Relax and Rejuvenate</h3>
                    <h2 class="mb-1">Massage Treatments</h2>
                </div>
            </div>
            <div class="row align-items-center">
                <!-- Massage Treatment Information -->
                <div class="col-lg-6">
                    <img loading="lazy" src="images/Massage2.jpeg" alt="Swedish Massage Treatment" class="img-fluid">
                </div>
                <div class="col-lg-6">
